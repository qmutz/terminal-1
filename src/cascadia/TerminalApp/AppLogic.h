...
namespace winrt::TerminalApp::implementation
{
    ...
    public:
        ...
        DECLARE_EVENT_WITH_TYPED_EVENT_HANDLER(SettingsChanged, _settingsChangedHandlers, winrt::Windows::Foundation::IInspectable, winrt::TerminalApp::CascadiaSettings);
